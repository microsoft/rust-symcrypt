...
mod tests {
    ...
    fn test_ecdsa_sign_without_private_key() {
        ...
        let key = EcKey::set_public_key(CurveType::NistP256, &public_key_bytes, EcKeyUsage::EcDsa).unwrap();
    ...
    fn test_ecdsa_sign_and_verify_different_curve_type() {
        ...
        let key2 = EcKey::set_public_key(CurveType::Curve25519, &public_key_bytes, EcKeyUsage::EcDsa).unwrap_err();
    ...
    fn test_ecdsa_sign_with_imported_key() {
        ...
        let key = EcKey::set_key_pair(CurveType::NistP256, &private_key, None, EcKeyUsage::EcDsa).unwrap();
